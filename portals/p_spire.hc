...
void(vector org) spire_rubble = {
	...
	if ((chunk_cnt < CHUNK_MAX) && (random() < 0.36250))
	{
		...
		rock.angles = randomv('-360.00000 -360.00000 -360.00000','360.00000 360.00000 360.00000');
		...
		rock.scale = 0.1;
		rock.lip = random(0.30000,1.40000);
		if (flak<0.8) {
...
void() spire_trail = {
	...
	particle2 ( (trace_endpos + randomv('-5 -5 -5', '5 5 5')), '-30.00000 -30.00000 50.00000', '30.00000 30.00000 100.00000', random(160, 175), 2, 10.00000);
