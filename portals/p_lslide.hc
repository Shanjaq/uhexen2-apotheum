...
void (float bigness)rock_launch = {
	...
	{
		particle2 ( self.origin + (random_vector + randomv('-64 -64 0', '64 64 24')), '-64.00000 -64.00000 50.00000', '64.00000 64.00000 100.00000', random(112, 127), PARTICLETYPE_FASTGRAV, random(12.00000, 32.00000));
		flak = random();
		rock = spawn();
		rock.spelldamage = self.spelldamage;
		setorigin (rock, self.origin + random_vector);
		rock.velocity = randomv('-500 -500 -30','500 500 150'); // notice the accent on the up velocity
		rock.avelocity = randomv('-700.00000 -700.00000 -700.00000','700.00000 700.00000 700.00000');
...
//		particle2 ( (self.origin + randomv('-30 -30 0', '30 30 100')), '-30.00000 -30.00000 50.00000', '30.00000 30.00000 100.00000', random(160, 175), 2, 80.00000);
