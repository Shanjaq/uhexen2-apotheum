void  ()LightningStrike =  {
	...
	self.dest2 = (self.origin + randomv('-256 -256 1024', '256 256 1024'));
...
void  ()yellowM1B =  {
	...
	if (time < self.splash_time) {
		particle2 ( (self.origin + randomv('-60 -60 -30', '60 60 30')), '-30.00000 -30.00000 490.00000', '30.00000 30.00000 -490.00000', random(168, 175), 0, 1.00000);
		particle2 ( (self.origin + randomv('-60 -60 -30', '60 60 30')), '-30.00000 -30.00000 490.00000', '30.00000 30.00000 -490.00000', random(168, 175), 0, 1.00000);

		if (random() < 0.12500) {
			self.effects = (self.effects | EF_MUZZLEFLASH);
			self.velocity += randomv('-16 -16 -8', '16 16 8');
			...
			if (targ != world)
			{
				...
				do_lightning ( self, 3, STREAM_ATTACHED, 0.50000, self.origin, ((targ.absmin + targ.absmax) * 0.50000), self.dmg, TE_STREAM_LIGHTNING);
			}
			else
			{
...
void  ()obj_yellowM1 =  {
	...
	while (num_shots > 0) {
		...
		missile.velocity += randomv((v_right * 125), (v_right * -125));
		missile.velocity += randomv((v_up * 10), (v_up * -10));
		...
		thinktime missile : random(0.03625, 0.10000);
