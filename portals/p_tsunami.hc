...
void() tsunami_rubble = {
	...
	if (random(1, 20) < 4) {
		//setorigin(newmis, (self.origin + randomv('-200 -200 0', '200 200 200')));
		setorigin(newmis, (self.origin + randomv('-200 -200 5', '200 200 70')));

	} else {
		//setorigin(newmis, randomv((tsunami_left + randomv('0 0 0', differencia)), (tsunami_right + randomv('0 0 0', differencia))));
		setorigin(newmis, randomv(tsunami_left, tsunami_right));
		newmis.origin_z += (differencia_z / 4);
	}
	newmis.scale = random(0.9, 1.4);
	newmis.count = random(1, 5);
	if (newmis.count < 6) {
...
void() tsunami_washer_touch = {
	if ((other.takedamage == DAMAGE_YES) && ((other.model != "models/tree2.mdl") || (other.model != "models/ntree.mdl") || (other.model != "models/tree.mdl") || (other.classname != "ntreetop") || (other.classname != "tree2top"))) {
		...
		setorigin(other, (other.origin + randomv('0 0 10', '0 0 20')));
	}
};
...
void() tsunami_washer_think = {
	...
	if (self.cnt < 40) {
		...
		particle2 ( (self.origin + randomv('-200 -200 -20', '200 200 200')), '-90.00000 -90.00000 40.00000', '90.00000 90.00000 140.00000', random(144, 159), 17, random(1, 15));
		thinktime self : 0.1;
...
void() tsunami_washer = {
	...
	if (random(1, 20) < 4) {
		setorigin(newmis, (self.origin + randomv('-200 -200 0', differencia)));
	...
	makevectors(self.angles);
	newmis.velocity -= (v_forward * 600);
	newmis.avelocity = randomv('0 -200 0', '0 200 0');
...
// particle2 ( (self.origin + randomv('-30 -30 0', '30 30 300')), '-30.00000 -30.00000 50.00000', '30.00000 30.00000 100.00000', random(96, 104), 15, 80.00000);
