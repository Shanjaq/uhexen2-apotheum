void() cloud_think = {
	...
	if (time < self.lifespan)
	{
		...
		else if (self.cloud_style == 1)
		{
			if (random() < 0.500)
			{
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(144, 159), 0, 1.00000);
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(144, 159), 0, 1.00000);
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(144, 159), 0, 1.00000);
			}
		}
		else if (self.cloud_style == 2)
		{
			if (random() < 0.500)
			{
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(128, 143), 0, 1.00000);
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(128, 143), 0, 1.00000);
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(128, 143), 0, 1.00000);
				particle2 ( (self.origin + (randomv('-170 -170 -30', '170 170 0') * self.spellradiusmod)), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(128, 143), 0, 1.00000);
			}
...
void() clouds_build =
{
	...
	if (time < self.lifespan)
	{
		...
		thinktime self : (random(0.35000, 0.75000) / self.spellradiusmod);
...
void(entity spawner) clouds_spawner =
{
	...
	thinktime spawner : HX_FRAME_TIME;
