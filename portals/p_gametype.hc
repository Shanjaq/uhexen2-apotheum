...
void (entity magician)make_mage = {
	...
	if (heresy) {
		...
		while ( found ) {
			...
			if ( (found.classname == "mage_spot") ) {
				setorigin(magician, found.origin);
				magician.angles = found.angles;

			}
			found = find ( found, classname, "mage_spot");

		}
	}
	*/

	magician.velocity = '0 0 0';
	magician.mage = 1;
	if (deathmatch) {
		magician.level = 9;
		magician.max_health = 200;
		magician.health = 200;
		magician.max_mana = 200;
//		magician.bluemana = magician.max_mana;
//		magician.greenmana = magician.max_mana;
		magician.elemana = (magician.max_mana * 0.50000);
		magician.Lfinger1S = ceil(random(0.5, 36));
		magician.Lfinger2S = ceil(random(0.5, 36));
		magician.Lfinger3S = ceil(random(0.5, 36));
		magician.Lfinger4S = ceil(random(0.5, 36));
		magician.Lfinger5S = ceil(random(0.5, 36));

		magician.Rfinger1S = ceil(random(0.5, 36));
		magician.Rfinger2S = ceil(random(0.5, 36));
		magician.Rfinger3S = ceil(random(0.5, 36));
		magician.Rfinger4S = ceil(random(0.5, 36));
		magician.Rfinger5S = ceil(random(0.5, 36));

		magician.Lfinger1Support = 0;
		magician.Lfinger2Support = 0;
		magician.Lfinger3Support = 0;
		magician.Lfinger4Support = 0;
		magician.Lfinger5Support = 0;
		
		magician.Rfinger1Support = 0;
		magician.Rfinger2Support = 0;
		magician.Rfinger3Support = 0;
		magician.Rfinger4Support = 0;
		magician.Rfinger5Support = 0;
		
		i = ceil(random(0.5, 3));
		while (i > 0)
		{
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Lfinger1S]) & themod) && (!(magician.Lfinger1Support & themod)) )
				magician.Lfinger1Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Lfinger2S]) & themod) && (!(magician.Lfinger2Support & themod)) )
				magician.Lfinger2Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Lfinger3S]) & themod) && (!(magician.Lfinger3Support & themod)) )
				magician.Lfinger3Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Lfinger4S]) & themod) && (!(magician.Lfinger4Support & themod)) )
				magician.Lfinger4Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Lfinger5S]) & themod) && (!(magician.Lfinger5Support & themod)) )
				magician.Lfinger5Support (+) themod;
			

			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Rfinger1S]) & themod) && (!(magician.Rfinger1Support & themod)) )
				magician.Rfinger1Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Rfinger2S]) & themod) && (!(magician.Rfinger2Support & themod)) )
				magician.Rfinger2Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Rfinger3S]) & themod) && (!(magician.Rfinger3Support & themod)) )
				magician.Rfinger3Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Rfinger4S]) & themod) && (!(magician.Rfinger4Support & themod)) )
				magician.Rfinger4Support (+) themod;
			themod = fexp(2, floor(random(0.0, 5.0)));
			if ( (random() < 0.36250) && ((spell_support[magician.Rfinger5S]) & themod) && (!(magician.Rfinger5Support & themod)) )
				magician.Rfinger5Support (+) themod;
