...
void ()crushdrop_fx_think = {
	if (time < self.splash_time)
	{
		...
		{
			self.think = crushdrop_fx_touch;
			self.velocity = randomv('0 0 240', '0 0 320');
			thinktime self : HX_FRAME_TIME;
		}
		else
		{
...
void (vector start)crushdrop_fx = {
	...
	newmis.angles = randomv('0.00000 -360.00000 0.00000','0.00000 360.00000 0.00000');
	newmis.avelocity = randomv('0.00000 -40.00000 0.00000','0.00000 40.00000 0.00000');
...
void ()launch_crushdrop = {
	...
	newmis.drawflags (+) (DRF_TRANSLUCENT | MLS_ABSLIGHT);
	newmis.avelocity = randomv('0.00000 -400.00000 0.00000','0.00000 400.00000 0.00000');
