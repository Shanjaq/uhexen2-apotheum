...
void ()firehail = {
	...
	org = (self.origin + (randomv('-150 -150 -15', '150 150 0') * self.spellradiusmod));
	...
	if (i < 4)
	{
		...
		newmis.velocity = randomv('-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000');
...
void() inferno_melee =
{
	...
	while(found)
	{
		particle2 (randomv(found.absmin, found.absmax), '-30.00000 -30.00000 50.00000', '30.00000 30.00000 100.00000', 140.00000, 16, 10.00000);
		found = found.chain2;
	}
};
