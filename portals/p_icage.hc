void() cage_think = 
{
	...
	else 
	{
		...
		{
			thinktime self.controller : 0.5; // BAER changed from 1
...
void() cage_launch = 
{
	...
	newmis.angles = randomv('-700.00000 -700.00000 -700.00000','700.00000 700.00000 700.00000');
	setsize (newmis, '-45 -45 -30', '45 45 70');
	if (other.flags2 & FL_ALIVE) 
	{
		thinktime  other : newmis.cnt;
		//other.solid = SOLID_NOT;
	}
	thinktime newmis : 0.01;
