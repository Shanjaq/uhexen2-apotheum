void ()rainstorm_think = {
	...
	{
		particle2 ( (self.origin + randomv('-200 -200 0', '200 200 64')), '-30.00000 -30.00000 -190.00000', '30.00000 30.00000 -490.00000', random(144, 159), 0, 2.00000);
	...
	while (head)
	{
		if ((head.classname == "player") && visible(head)) {
			if (self.goalentity.origin == VEC_ORIGIN) {
				...
				setorigin (newmis, self.origin + randomv('-200 -200 200', '200 200 512'));
	...
	if (self.scale >= 1.2) {
		if (self.click != 1)
		{
			...
			*/
			...
			particle2 ( (self.origin + randomv('-30.00000 -30.00000 -30.00000','30.00000 30.00000 30.00000')), '-200.00000 -200.00000 -20.00000', '200.00000 200.00000 200.00000', 255.00000, 1, 80.00000);
			particle2 ( (self.origin + randomv('-90 -90 0', '90 90 30')), '-30.00000 -30.00000 50.00000', '30.00000 30.00000 100.00000', random(243, 246), 2, 20.00000);
