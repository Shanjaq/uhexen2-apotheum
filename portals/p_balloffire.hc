...
void() balloffire_water_blast = {
	...
	if (self.cnt == 1)
	{
		...
		{
			particle2 ( self.origin + (randomv('-64 -64 -64', '64 64 64') * self.scale) - '0 0 64', '-7.00000 -7.00000 150.00000', '7.00000 7.00000 300.00000', 255.00000, 17, random(48.00000, 72.00000));
			setorigin (self.oldenemy, self.origin + (randomv('-64 -64 -64', '64 64 64') * self.scale));
...
void() balloffire_crash = {
	...
	if (other.takedamage == DAMAGE_YES)
	{
		...
		other.velocity += randomv('-32 -32 10', '32 32 24');
	...
	self.oldweapon = 1;
	self.lip = 1.2 * self.spellradiusmod;
	splashy();
	remove(self);
};
