float IMPULSE_P_SHOP = 55;
float IMPULSE_P_STATUS = 56;
float IMPULSE_P_SPELLSCHEAT = 57;
float IMPULSE_P_SPELLDEC = 58;
float IMPULSE_P_SPELLINC = 59;
float IMPULSE_P_SPELLLEFT = 60;
float IMPULSE_P_SPELLRIGHT = 61;
float IMPULSE_P_SPELLUP = 62;
