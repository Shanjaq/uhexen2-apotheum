...
void() tossabrick =
{
	...
	newmis.velocity = randomv('-180 -180 -30','400 400 900'); // notice the accent on the up velocity
	// newmis.avelocity = randomv('10 10 10', '300 300 300'); // or however fast the spin would be 
...
void() CometCrash = {
	...
	thinktime self.goalentity : 0.50000;
...
void() CometFall = {
	...
	self.dest = randomv(self.dest,trace_endpos);
	traceline ( self.dest, (self.dest - '0.00000 200.00000 0.00000'), TRUE, self);
	self.dest = randomv(self.dest,trace_endpos);
